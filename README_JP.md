...
Gentask は **Microsoft 365（Planner + Outlook）** と **Google（Tasks + Calendar）** の双方と **Gemini 2.0 Flash（Vertex AI）** を GenKit 経由で統合する CLI ツールです。実行するコマンドや設定に応じてバックエンド（Planner または Google Tasks）が選択されます。
